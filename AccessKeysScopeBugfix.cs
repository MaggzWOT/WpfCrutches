// By Tim Valentine of http://coderelief.net/2012/07/29/wpf-access-keys-scoping/
//     (with minor renames to make the intention more obvious)
//
// This code is not GPL like the rest of WpfCrutches; see link above for details
//     but it's basically "do-anything with attribution".
//
// More links to the bug report:
...
{
    /// <summary>
    /// WPF access key handling is broken in that access keys aren't scoped correctly. Imagine a context menu or a sub-menu
    /// which defines an access key also used in the main window by another control. In WPF, contrary to how access keys
    /// have worked in Windows for more than a decade, the main window's element will be activated instead of the menu item
    /// in the sub-menu.
    /// </summary>
    /// <remarks>
    /// To use, add a namespace to the Window: xmlns:wpfc="clr-namespace:WpfCrutches;assembly=WpfCrutches"
    /// and then set the property on the Window element: wpfc:AccessKeysScopeBugfix.IsEnabled="true".
    /// </remarks>
    public static class AccessKeysScopeBugfix
    {
        /// <summary>
        ...
        public static readonly DependencyProperty IsEnabledProperty
            ...
            typeof(AccessKeysScopeBugfix), new PropertyMetadata(false, OnIsEnabledChanged));
